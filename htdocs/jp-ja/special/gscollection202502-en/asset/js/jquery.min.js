              ...
              (t =
                b || Y.test(o.contains)
                  ? function (a, b) {
                      ...
                      return (
                        a === d ||
                        !(!d || d.nodeType !== 1 || !(c.contains ? c.contains(d) : a.compareDocumentPosition && 16 & a.compareDocumentPosition(d)))
                      )
                    }
                  : function (a, b) {
            ...
            CLASS: function (a) {
              ...
              return (
                ...
                ((b = new RegExp('(^|' + K + ')' + a + '(' + K + '|$)')) &&
                  y(a, function (a) {
                    return b.test(
                      (typeof a.className === 'string' && a.className) || (typeof a.getAttribute !== 'undefined' && a.getAttribute('class')) || ''
                    )
                  }))
              )
            },
  ...
  ;(V.uid = 1),
    (V.prototype = {
      cache: function (a) {
        ...
        return (
          b || ((b = {}), U(a) && (a.nodeType ? (a[this.expando] = b) : Object.defineProperty(a, this.expando, { value: b, configurable: !0 }))), b
        )
      },
      set: function (a, b, c) {
        let d
  ...
  r.extend({
    ...
    r.extend({
      queue: function (a, b, c) {
        ...
        if (a)
          return (
            (b = (b || 'fx') + 'queue'), (d = W.get(a, b)), c && (!d || Array.isArray(c) ? (d = W.access(a, b, r.makeArray(c))) : d.push(c)), d || []
          )
      },
  ...
  r.extend({
    ...
    ajax: function (b, c) {
      ...
      ;(l = r.event && o.global),
        ...
        (f = o.url.replace(Cb, '')),
        o.hasContent
          ? o.data && o.processData && (o.contentType || '').indexOf('application/x-www-form-urlencoded') === 0 && (o.data = o.data.replace(Bb, '+'))
  ...
  r.ajaxSetup({
    ...
    r.ajaxPrefilter('json jsonp', function (b, c, d) {
      ...
      const h =
        ...
        (Ub.test(b.url)
          ? 'url'
          : typeof b.data === 'string' && (b.contentType || '').indexOf('application/x-www-form-urlencoded') === 0 && Ub.test(b.data) && 'data')
